...
const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Ile kosztuje OneLink po zakończeniu bezpłatnego trialu?", "acceptedAnswer": { "@type": "Answer", "text": "Plany zaczynają się od 49,99 zł miesięcznie netto (+ VAT). Szczegóły wszystkich planów znajdziesz na stronie /pricing. Możesz anulować w dowolnym momencie — bez okresu wypowiedzenia." } },
...
export default function RootLayout({
  ...
  return (
    <html lang="pl" translate="no" suppressHydrationWarning>
      <head>
        <script
